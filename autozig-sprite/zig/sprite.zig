...
// Color type (matches autozig-color)
...
pub const TextureAtlas = extern struct {
    ...
    pub fn calculateUV(self: TextureAtlas, texture_size: Vec2) [4]f32 {
        ...
        const padding = layout.padding orelse Vec2.zero();
        const offset = layout.offset orelse Vec2.zero();
...
// Create sprite quad vertices with custom UV
